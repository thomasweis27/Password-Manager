...
def removeFromDatabase(user_hash, inputtedPassword, credentialsMainScreen, viewCredentialScreen, confirmPopup, selected_set):
...
def deleteCredentialSet(user_hash, inputtedPassword, credentialsMainScreen, viewCredentialScreen, selected_set):
    ...
    confirmButton = tk.Button(confirmPopup, text = "Confirm Deletion",
        ...
        command = lambda:removeFromDatabase(user_hash, inputtedPassword, credentialsMainScreen, viewCredentialScreen, confirmPopup, selected_set))
    confirmButton.pack()
...
def viewCredentialSet(user_hash, inputtedPassword, credentialsMainScreen, previousWindow, selected_set):
    ...
    deleteSetButton = tk.Button(viewCredentialScreen, text = "Delete Set",
        command = lambda:deleteCredentialSet(user_hash, inputtedPassword, credentialsMainScreen, viewCredentialScreen, selected_set))
